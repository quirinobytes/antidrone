...
<div id="mainwrap">	<div id="pagetop"><div id="pagetop-inner">
    	<div id="header" class="clearfix">
            ...
            <a href="?" id="but-green"><span>Comprar Assim que dispon&iacute;vel</span></a>
        </div>
...
<div class="half float_l">
                    <div id="contact_form">
                      <form action="comprar.php" method="post" id="contact">
...
<label for="email"> Email</label>
                        ...
                        T&iacute;tulo</label>
                        <input name="subject" type="text" class="input_field" id="subject" value="Quero comprar" size="46" />
                        <br />
                        <br />
