        ...
        <div id="content">
       	  <div id="content-inner">
                <div id="templatemo_main">
                  <h3>Posso contribuir com meu trabalho?</h3><hr /><br />
<div class="half float_l">
                    <div id="contact_form">
                      <form action="contribuir.php" method="post" id="contact">
...
<label for="email"> Email</label>
                        ...
                        T&iacute;tulo</label>
                        <input name="subject" type="text" class="input_field" id="subject" value="Posso Colaborar?" size="46" />
                        <br />
                        <br />
